...
class PickPlaceHsr(ManipulationEnv):
    """
...
class PickPlaceSingle(PickPlaceHsr):
    """
...
class PickPlaceObject(PickPlaceHsr):
    """
    ...
    def __init__(self, **kwargs):
        ...
        super().__init__(single_object_mode=2, object_type="object", **kwargs)