...
class Hsr(ManipulatorModel):
    ...
    def __init__(self, idn=0):
        super().__init__(xml_path_completion("/home/deepstation/rfm/RoboManipBaselines/robo_manip_baselines/envs/assets/mujoco/robots/hsr/hsr_body.xml"), idn=idn)
